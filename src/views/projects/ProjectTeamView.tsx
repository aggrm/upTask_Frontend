...
import { deleteUserToProject, getProjectTeam } from '@/api/TeamAPI';
...
export default function ProjectTeamView() {
  ...
  const { mutate } = useMutation({
    mutationFn: deleteUserToProject,
    onError : (error) => {
  ...
  if(data) return (
    <>
      ...
      <p className='text-2xl font-light'>Administra el equipo de trabajo para este proyecto</p>
